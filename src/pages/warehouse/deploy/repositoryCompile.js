...
const RepositoryCompile = (props) => {
    ...
    return(
        <div className=' compile'>
            <div className='compile-width'>
                <div className='flex justify-between'>
                    <div className=' title'>配置</div>
                    <div className='mt-3'>
                        <Button type="primary" htmlType="submit" onClick={openDeletePop}>
                            删除
                        </Button>
                    </div>
                </div>
                <Deploy type={"compile"} repositoryId={params.id} {...props} />
                <div className='mt-6'>
                    <Form
                        {...layout}
                        form={form}
...
export default RepositoryCompile
