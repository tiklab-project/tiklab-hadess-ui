...
const TopNav = (props) => {
    ...
    const {showType,collapsed,setTheme,theme,repositoryStore}=props
    ...
    return(
        <div className='top-nav'>
            ...
            <div className='tab-link'>
                {version!=='cloud'?<HelpLink  bgroup={'hadess'}
                                              iconComponent={
                                                  collapsed ?
                    ...
                    iconComponent={
                        collapsed ?
                            <div className='close-tab'>
                                <QuestionCircleOutlined className=' close-iconfont' data-title-right='帮助'/>
                            </div>
                            :
                            <div className='open-tab'>
                                <div className="open-iconfont"><QuestionCircleOutlined/></div>
